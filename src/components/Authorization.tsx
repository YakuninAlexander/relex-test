...
export default function Authorization() {
  ...
  return(
    <form onSubmit={submitHandler} className='max-w-[500px]  mx-auto py-4 flex flex-col col mt-5 items-center rounded-lg drop-shadow-xl bg-slate-400 gap-4 content-center justify-around'>
